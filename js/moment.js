!(function (e, a) {
  ...
  function ba(e, a, t, s, n) {
    ...
    return (
      ...
      (d._f = a),
      (d._strict = s),
      (r = new k(la(Ha(d))))._nextDay && (r.add(1, 'd'), (r._nextDay = void 0)),
      r
    );
  }
  function Sa(e, a, t, s) {
  ...
  (Xt.isValid = function () {
    ...
    (Xt.as = function (e) {
      ...
      if ('month' === (e = N(e)) || 'quarter' === e || 'year' === e)
        switch (((a = this._days + s / 864e5), (t = this._months + Ht(a)), e)) {
          case 'month':
            return t;
          case 'quarter':
            return t / 3;
        ...
        switch (((a = this._days + Math.round(bt(this._months))), e)) {
          case 'week':
            return a / 7 + s / 6048e5;
          case 'day':
            return a + s / 864e5;
        ...
        null != a
          ? ((n = sa),
            null != na[e] && null != na[e].parentLocale
              ? na[e].set(H(na[e]._config, a))
              : (null != (s = ia(e)) && (n = s._config),
                (a = H(n, a)),
                null == s && (a.abbr = e),
                ((t = new b(a)).parentLocale = na[e]),
                (na[e] = t)),
            oa(e))
          : null != na[e] &&
  ...
  var bs = 'leden_\xfanor_b\u0159ezen_duben_kv\u011bten_\u010derven_\u010dervenec_srpen_z\xe1\u0159\xed_\u0159\xedjen_listopad_prosinec'.split(
      '_'
    ),
  ...
  var sn = 'jan._feb._mrt._apr._mai_jun._jul._aug._sep._okt._nov._des.'.split(
      '_'
    ),
  ...
  function Pn(e, a, t, s) {
    ...
    return 1 === e
      ? n + jn(0, a, t[0], s)
      : a
      ? n + (xn(e) ? On(t)[1] : On(t)[0])
      : s
      ? n + On(t)[1]
      : n + (xn(e) ? On(t)[1] : On(t)[2]);
  }
  M.defineLocale('lt', {
    months: {
  ...
  var Bn = 'jan._feb._mrt._apr._mei_jun._jul._aug._sep._okt._nov._dec.'.split(
      '_'
    ),
  ...
  var sr = 'stycze\u0144_luty_marzec_kwiecie\u0144_maj_czerwiec_lipiec_sierpie\u0144_wrzesie\u0144_pa\u017adziernik_listopad_grudzie\u0144'.split(
      '_'
    ),
    nr = 'stycznia_lutego_marca_kwietnia_maja_czerwca_lipca_sierpnia_wrze\u015bnia_pa\u017adziernika_listopada_grudnia'.split(
      '_'
    );
  function rr(e) {
  ...
  var lr = 'janu\xe1r_febru\xe1r_marec_apr\xedl_m\xe1j_j\xfan_j\xfal_august_september_okt\xf3ber_november_december'.split(
      '_'
    ),
    ...
    translate: function (e, a, t) {
      ...
      return 1 === t.length
        ? a
          ? s[0]
          : s[1]
        : e + ' ' + Yr.correctGrammaticalCase(e, s);
    },
  };
  ...
  var Dr = 'pagh_wa\u2019_cha\u2019_wej_loS_vagh_jav_Soch_chorgh_Hut'.split(
    '_'
  );
  function Tr(e, a, t, s) {
    var n = (function (e) {
